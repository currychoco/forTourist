...
/**
 * Servlet implementation class QuartersReviewDeleteAction
 */
@WebServlet("/QuartersReviewDeleteAction")
public class QuartersReviewDeleteAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public QuartersReviewDeleteAction() {
        super();
