...
/**
 * Servlet implementation class AreaWriteReviewAction
 */
@WebServlet("/AreaWriteReviewAction")
public class AreaWriteReviewAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AreaWriteReviewAction() {
        super();
