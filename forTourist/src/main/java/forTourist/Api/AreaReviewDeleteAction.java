...
/**
 * Servlet implementation class AreaReviewDeleteAction
 */
@WebServlet("/AreaReviewDeleteAction")
public class AreaReviewDeleteAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AreaReviewDeleteAction() {
        super();
