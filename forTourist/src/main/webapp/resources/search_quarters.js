        ...
        console.log(list);
         list.forEach(e=>{
              ...
              $(".container").append(
                  ...
                  <li id = "thumbnail"><a href = "writeReviewQuerters.jsp?contentid=${contentid}&title=${title}&addr1=${addr1}&firstimage=${image}"><img src="${image}" id = "firstimg" name = "firstimg"></a></li>
